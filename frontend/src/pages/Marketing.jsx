...
const riskLevelData = [
  { name: 'Low Risk', value: 65, color: '#10B981' }, // Green
  { name: 'Medium Risk', value: 25, color: '#F59E0B' }, // Yellow
...
export default function Marketing() {
  return (
    <div className="w-full text-white animate-in fade-in duration-500">
      ...
      <div className="bg-[#13151D] rounded-[32px] p-8 border border-[#1e2230] relative overflow-hidden lg:w-1/2">
